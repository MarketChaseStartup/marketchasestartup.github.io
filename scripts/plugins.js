var Plugins = (function(){
    return {
        ...
        Mensagem : (function(){
            return{
                aviso : function(mensagem,fixo,callback){
                ...
                alerta : function(mensagem,fixo,callback){
                	$().toastmessage('showToast', {
                        text     : mensagem,
                        sticky   : fixo,
                        position : 'top-right',
                ...
                sucesso : function(mensagem,fixo,callback){
                	$().toastmessage('showToast', {
                        text     : mensagem,
                        sticky   : fixo,
                        position : 'top-right',
                ...
                erro : function(mensagem,fixo,callback){
                	$().toastmessage('showToast', {
                        text     : mensagem,
                        sticky   : fixo,
                        position : 'top-right',
